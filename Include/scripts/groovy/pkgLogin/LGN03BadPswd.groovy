...
class LGN03BadPswd {
	...
	def configRequest() {
		...
		GlobalVariable.vTempHTTPCode = findTestData('04-ResponseCodes/HTTPCodes').getValue(2, 2)
		GlobalVariable.vErrorCode = findTestData('05-WSSecurity/CodigosError').getValue(1,2)
		GlobalVariable.vErrorDescription = findTestData('05-WSSecurity/CodigosError').getValue(2,2)
