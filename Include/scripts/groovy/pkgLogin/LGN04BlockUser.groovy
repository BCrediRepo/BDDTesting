...
class LGN04BlockUser {
	...
	def configRequest() {
		...
		GlobalVariable.vTempHTTPCode = findTestData('04-ResponseCodes/HTTPCodes').getValue(2, 3)
		GlobalVariable.vErrorCode = findTestData('05-WSSecurity/CodigosError').getValue(1,3)
		GlobalVariable.vErrorDescription = findTestData('05-WSSecurity/CodigosError').getValue(2,3)
	...
	def verifyResponse() {
		...
		//JOptionPane.showMessageDialog(null, GlobalVariable.vErrorCode)
		WS.verifyElementPropertyValue(GlobalVariable.vResponse, 'error_code', GlobalVariable.vErrorCode)
		WS.verifyElementPropertyValue(GlobalVariable.vResponse, 'error_description', GlobalVariable.vErrorDescription)
