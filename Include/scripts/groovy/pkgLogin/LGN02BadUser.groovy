...
class LGN02BadUser {
	...
	def configRequest() {
		...
		GlobalVariable.vErrorCode = findTestData('05-WSSecurity/CodigosError').getValue(1,1)
		GlobalVariable.vErrorDescription = findTestData('05-WSSecurity/CodigosError').getValue(2,1)
